...
if __name__ == "__main__": 
    ...
    # delay_time, search, filename
    # py -3.10 anue_past_news.py 3 面板 2023121613_anue_面板.json
    # filenames: 2023121610_anue_友達.json
    # filenames: 2023121612_anue_2409.json
    # filenames: 2023121613_anue_面板.json
    ##################################################    
    if (len(sys.argv) < 2):
    ...
    if sys.argv[1]:
        ...
        print("have already stored in database!!!!")
