...
def main(delay_time, search):
    ...
    driver = webdriver.Chrome('C:/Users/USER/Desktop/sentiment_pc/chromedriver.exe')
    ...
    while True:
        ...
        try:
            ...
            print(f"Implement TIme: {datetime.now()}")
...
if __name__ == "__main__": # python anue.py 3 有ㄉㄚ
    if (len(sys.argv) < 2):
