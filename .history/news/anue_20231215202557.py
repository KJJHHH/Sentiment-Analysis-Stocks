...
def get_selenium():                           
    ...
    driver = webdriver.Chrome('C:/Users/USER/Desktop/sentiment_pc/news/chromedriver.exe'chrome_options=options)
    return (driver)
...
def main(delay_time, search):
    ...
    driver_path = 'C:/Users/USER/Desktop/sentiment_pc/news/chromedriver.exe'
    ...
    while True:
        ...
        try:
            ...
            for article_link in article_links:
                print("Already have!!!") if article_link in dict_unipost else None
