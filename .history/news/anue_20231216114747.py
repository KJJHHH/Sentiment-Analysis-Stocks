...
def main(filename, delay_time, search):
    '''
    ...
    while True:
        try:
            ...
            print("Scroll: No text from this scroll") if new_article == [] else print(new_article)
...
if __name__ == "__main__": 
    ...
    # py -3.10 anue.py 2023121610_anue_友達.json 3 友達    
    ##################################################
